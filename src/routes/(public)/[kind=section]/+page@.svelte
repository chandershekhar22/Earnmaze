...
<section class="hero">
  <div class="wrap">
    ...
    <h1 class="h-display reveal"><em>{data.kindLabel}.</em></h1>
    <p class="lead reveal d1">Hand-picked interactive experiences — explore, play with, and learn from. Earn points for engaging with each one.</p>
  </div>
</section>
    ...
    <div class="grid">
      ...
      {:else}
        {#each filtered as a (a.id)}
          <a class="card reveal" href="/{data.kind}/{a.id}" data-sveltekit-reload>
