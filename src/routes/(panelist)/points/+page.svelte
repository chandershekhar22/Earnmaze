...
<div class="space-y-5 animate-fade-in">
	...
	<div class="grid grid-cols-2 lg:grid-cols-4 gap-3">
		<div class="group relative overflow-hidden bg-surface-100 border border-white/[0.06] rounded-2xl p-4 md:p-5 hover:border-emerald-500/20 transition-all duration-300">
			<div class="absolute -top-8 -right-8 w-20 h-20 bg-emerald-500/5 rounded-full blur-xl group-hover:bg-emerald-500/10 transition-colors"></div>
			<div class="relative">
				<div class="p-2 bg-emerald-500/10 rounded-xl w-fit mb-3">
					<Coins class="w-4 h-4 text-emerald-400" />
				</div>
				<div class="text-[10px] font-bold text-neutral-600 uppercase tracking-widest mb-1">Available</div>
		...
		<div class="group relative overflow-hidden bg-surface-100 border border-white/[0.06] rounded-2xl p-4 md:p-5 hover:border-violet-500/20 transition-all duration-300">
			<div class="absolute -top-8 -right-8 w-20 h-20 bg-violet-500/5 rounded-full blur-xl group-hover:bg-violet-500/10 transition-colors"></div>
			<div class="relative">
				<div class="p-2 bg-violet-500/10 rounded-xl w-fit mb-3">
					<TrendingUp class="w-4 h-4 text-violet-400" />
				</div>
				<div class="text-[10px] font-bold text-neutral-600 uppercase tracking-widest mb-1">Lifetime</div>
		...
		<div class="group relative overflow-hidden bg-surface-100 border border-white/[0.06] rounded-2xl p-4 md:p-5 hover:border-pink-500/20 transition-all duration-300">
			<div class="absolute -top-8 -right-8 w-20 h-20 bg-pink-500/5 rounded-full blur-xl group-hover:bg-pink-500/10 transition-colors"></div>
			<div class="relative">
				<div class="p-2 bg-pink-500/10 rounded-xl w-fit mb-3">
					<Gift class="w-4 h-4 text-pink-400" />
				</div>
				<div class="text-[10px] font-bold text-neutral-600 uppercase tracking-widest mb-1">Redeemed</div>
		...
		<div class="group relative overflow-hidden bg-surface-100 border border-white/[0.06] rounded-2xl p-4 md:p-5 hover:border-sky-500/20 transition-all duration-300">
			<div class="absolute -top-8 -right-8 w-20 h-20 bg-sky-500/5 rounded-full blur-xl group-hover:bg-sky-500/10 transition-colors"></div>
			<div class="relative">
				<div class="p-2 bg-sky-500/10 rounded-xl w-fit mb-3">
					<BarChart3 class="w-4 h-4 text-sky-400" />
				</div>
				<div class="text-[10px] font-bold text-neutral-600 uppercase tracking-widest mb-1">Net</div>
	...
	<div class="grid grid-cols-1 md:grid-cols-3 gap-3">
		<a href="/surveys" class="group flex items-center gap-3 p-4 bg-surface-100 border border-white/[0.06] hover:border-primary-500/20 hover:bg-surface-200 rounded-xl transition-all">
			...
			<div class="flex-1">
				<div class="font-semibold text-white text-sm">Earn More</div>
				<div class="text-[10px] text-neutral-600">Take surveys</div>
			</div>
			<ChevronRight class="w-4 h-4 text-neutral-700 group-hover:text-primary-400 group-hover:translate-x-0.5 transition-all" />
		</a>

		<a href="/rewards" class="group flex items-center gap-3 p-4 bg-surface-100 border border-white/[0.06] hover:border-emerald-500/20 hover:bg-surface-200 rounded-xl transition-all">
			...
			<div class="flex-1">
				<div class="font-semibold text-white text-sm">Redeem</div>
				<div class="text-[10px] text-neutral-600">Get rewards</div>
			</div>
			<ChevronRight class="w-4 h-4 text-neutral-700 group-hover:text-emerald-400 group-hover:translate-x-0.5 transition-all" />
		</a>

		<a href="/history" class="group flex items-center gap-3 p-4 bg-surface-100 border border-white/[0.06] hover:border-sky-500/20 hover:bg-surface-200 rounded-xl transition-all">
			<div class="p-2 bg-sky-500/10 rounded-lg group-hover:bg-sky-500/15 transition-colors">
				<History class="w-4 h-4 text-sky-400" />
			</div>
			<div class="flex-1">
				<div class="font-semibold text-white text-sm">History</div>
				<div class="text-[10px] text-neutral-600">All activity</div>
			</div>
			<ChevronRight class="w-4 h-4 text-neutral-700 group-hover:text-sky-400 group-hover:translate-x-0.5 transition-all" />
		</a>
	</div>
	...
	<div class="card !p-0 overflow-hidden">
		<div class="flex items-center justify-between px-5 pt-5 pb-3">
			...
			<a href="/history" class="group inline-flex items-center gap-1 text-xs font-bold text-neutral-600 hover:text-primary-400 transition-colors uppercase tracking-wider">
				All
		...
		{#if !transactions || transactions.length === 0}
			<div class="text-center py-16 px-6">
				...
				<h3 class="text-sm font-bold text-white mb-1">No transactions yet</h3>
				<p class="text-xs text-neutral-600 mb-4">Complete surveys to start earning</p>
				<a href="/surveys" class="btn-primary !text-xs">
				...
				{#each transactions.slice(0, 10) as transaction}
					...
					<div class="flex items-center gap-3 px-5 py-3 hover:bg-white/[0.02] transition-colors">
						...
						<div class="text-right flex-shrink-0">
							<div class="text-sm font-black {transaction.points > 0 ? 'text-emerald-400' : 'text-rose-400'}">
								{transaction.points > 0 ? '+' : ''}{transaction.points.toLocaleString()}
							</div>
							<div class="text-[10px] text-neutral-700">Bal: {transaction.currentBalance.toLocaleString()}</div>
						</div>
					</div>
				{/each}
			</div>
